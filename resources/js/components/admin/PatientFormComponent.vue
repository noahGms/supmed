                ...
                <form class="flex flex-col">
                  ...
                  <div class="flex flex-row pt-4">
                    <div class="w-40 mr-4">
                      ...
                      >
                      <input
                        v-model="patient.address.street_number"
                        type="number"
                        id="street_number"
                        placeholder="200"
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline"
                    ...
                    <div>
                      ...
                      >
                      <input
                        v-model="patient.address.street_name"
                        type="text"
                        id="street_name"
...
export default {
  ...
  methods: {
    save () {
      if (this.create) {
        this.$store.dispatch('newPatient', this.patient).then(response => {
          this.patientListing()
          this.close()
        })
      } else {
        this.$store.dispatch('updateOnePatient', this.patient).then(response => {
          this.patientListing()
          this.close()
        })
      }
    ...
    formValid () {
      if (this.create) {
        return !(
          ...
          !!this.patient.password_confirmation
        )
      } else {
        return false
      }
