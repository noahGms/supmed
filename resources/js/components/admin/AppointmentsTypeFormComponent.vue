...
export default {
  ...
  methods: {
    save () {
      if (this.create) {
        this.$store.dispatch('newAppointmentsType', this.appointmentsType).then(response => {
          this.appointmentsTypeListing()
          this.close()
        })
      } else {
        this.$store.dispatch('updateOneAppointmentsType', this.appointmentsType).then(response => {
          this.appointmentsTypeListing()
          this.close()
        })
      }
